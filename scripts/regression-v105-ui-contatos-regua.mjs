...
exigir(fonteUi.includes("import * as Core from './financeiro-core.mjs?v=109'"), 'runtime V109 preserva o núcleo financeiro validado pela V105');
exigir(fonteHtml.includes('./financeiro-ui-v104.mjs?v=109'), 'HTML V109 instala a UI financeira compatível com a V105');
exigir(
