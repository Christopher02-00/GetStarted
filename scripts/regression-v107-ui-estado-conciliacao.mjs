...
async function prepararAgregado(page) {
  await page.evaluate(() => {
    ...
    // A V109 acrescentou a conciliação histórica da Fedalto ao agregado. Esta
    ...
    window.preverCorrecaoFedaltoAgostoV109 = async () => {
      window.__correcaoFedaltoAgostoV109 = { resolvida: true };
      return true;
    };
