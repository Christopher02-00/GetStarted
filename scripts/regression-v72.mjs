...
exigir(/2026-08-(?:17-(?:regua-whatsapp-contatos-v72|cadastro-whatsapp-v73|identidade-filas-links-v74|valor-ativacao-reativacao-v75|auth-carteira-limpeza-v76|central-vendas-v77)|18-(?:contatos-arquivo-unico-v78|calendario-proximo-mes-v79|planos-premium-conteudos-vivos-v80|ciclo-clientes-propostas-v81))/.test(html),'build mantém a V72 ou uma sucessora validada');
...
let contato=contatoCtx.contatoWhatsAppCliente({whatsappFinanceiro:'(41) 99908-8357'});
exigir(contato.numero==='5541999088357'&&contato.origem==='agenda financeira privada','contato privado confirmado tem prioridade');
contato=contatoCtx.contatoWhatsAppCliente({telefone:'(41) 98888-7777',whatsappCobranca:'(41) 99908-8357'});
exigir(contato.numero===''&&contato.origem==='','campos legados não vazam para a ferramenta financeira');
exigir(contatoCtx.contatoWhatsAppCliente({whatsappFinanceiro:'sem número'}).numero==='','contato privado ausente não inventa destinatário');
...
exigir(consolidados[0].whatsappFinanceiro===undefined,'consolidação operacional não injeta contato financeiro privado');
