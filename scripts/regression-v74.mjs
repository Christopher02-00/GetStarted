...
ok(prepararLink.includes("estadoMesCal(calSnap.data()||{},mes)!=='liberado'")&&prepararLink.includes("'&mes='+encodeURIComponent(mes)"),'fallback de cópia perdeu a validação/competência mensal');
