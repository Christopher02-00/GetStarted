...
exigir(carga.includes('mesVisivel = pedido ||'),'link individual honra a competência explícita sem cair silenciosamente em outro mês');
...
exigir(calendario.includes("st === 'arquivado'")&&calendario.includes('Calendário arquivado'),'mês explicitamente arquivado mostra somente o estado de arquivo');
