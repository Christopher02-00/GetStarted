...
exigir(
  escritorio.includes('gs-build" content="2026-08-22-saida-canonica-joaquin-v106"') &&
  ...
  'cadeia V106 → V105 → V104 → V103 → V102 → V101 não foi identificada para reensaiar a correção V95'
);
