...
exigir(escritorio.includes('gs-build" content="2026-08-23-pagamento-fedalto-agosto-v108')&&
  escritorio.includes('gs-parent-patch" content="2026-08-22-estado-conciliacao-joaquin-v107'), 'V108 preserva V107 como pai');
exigir(escritorio.includes('gs-grandparent-patch" content="2026-08-22-saida-canonica-joaquin-v106')&&
  escritorio.includes('gs-great-grandparent-patch" content="2026-08-22-conciliacao-manual-regua-v105')&&
  escritorio.includes('gs-fourth-grandparent-patch" content="2026-08-22-correcao-financeiro-real-v104'), 'V108 preserva V106, V105 e V104 na cadeia');
exigir(escritorio.includes('gs-fifth-grandparent-patch" content="2026-08-21-financeiro-por-competencia-v103')&&
  escritorio.includes('gs-sixth-grandparent-patch" content="2026-08-21-itemids-calendarios-legados-v102')&&
  escritorio.includes('gs-seventh-grandparent-patch" content="2026-08-21-controle-conclusao-calendarios-v101'), 'V108 preserva V103, V102 e V101 na cadeia e o código V98 continua presente');
